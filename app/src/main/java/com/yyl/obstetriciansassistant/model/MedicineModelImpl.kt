...
class MedicineModelImpl :MedicineModel {
    ...
    override fun getRiskMedicineListFromInitail(s: String): List<Medicine> {
        val r1=Medicine("medicine test1","        val s=\"批准日期：2010-08-25%0D%0A剂型：其它剂型%0D%0A规格：每瓶装12毫升%3B30毫升%3B45毫升%3B88毫升%0D%0A储存：密封，置阴凉处%28不超过20°C%29。%0D%0A有效期：48个月。\"\n content")
        val r2=Medicine("medicine test2","        val s=\"批准日期：2010-08-25%0D%0A剂型：其它剂型%0D%0A规格：每瓶装12毫升%3B30毫升%3B45毫升%3B88毫升%0D%0A储存：密封，置阴凉处%28不超过20°C%29。%0D%0A有效期：48个月。\"\n content")
        val r3=Medicine("medicine test","        val s=\"批准日期：2010-08-25%0D%0A剂型：其它剂型%0D%0A规格：每瓶装12毫升%3B30毫升%3B45毫升%3B88毫升%0D%0A储存：密封，置阴凉处%28不超过20°C%29。%0D%0A有效期：48个月。\"\n content")
        val r4=Medicine("medicine test","medicine content")
        val r5=Medicine("medicine test","        val s=\"批准日期：2010-08-25%0D%0A剂型：其它剂型%0D%0A规格：每瓶装12毫升%3B30毫升%3B45毫升%3B88毫升%0D%0A储存：密封，置阴凉处%28不超过20°C%29。%0D%0A有效期：48个月。\"\n content")
    ...
    override fun getRiskMedicine(): List<Risk> {
        val medicine=Medicine("medicine test","        val s=\"批准日期：2010-08-25%0D%0A剂型：其它剂型%0D%0A规格：每瓶装12毫升%3B30毫升%3B45毫升%3B88毫升%0D%0A储存：密封，置阴凉处%28不超过20°C%29。%0D%0A有效期：48个月。\"\n content")
