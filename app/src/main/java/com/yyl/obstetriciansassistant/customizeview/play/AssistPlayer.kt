...
class AssistPlayer private constructor() {
    ...
    private val mInternalPlayerEventListener =
        OnPlayerEventListener { eventCode, bundle -> callBackPlayerEventListeners(eventCode, bundle) }

    private val mInternalErrorEventListener =
        OnErrorEventListener { eventCode, bundle -> callBackErrorEventListeners(eventCode, bundle) }

    private val mInternalReceiverEventListener =
        OnReceiverEventListener { eventCode, bundle -> callBackReceiverEventListeners(eventCode, bundle) }
    ...
    var receiverGroup: ReceiverGroup
        get() = mRelationAssist.receiverGroup as ReceiverGroup
        set(receiverGroup) {
    ...
    fun prepare(userContainer: ViewGroup, dataSource: DataSource?) {
        if (dataSource != null) {
